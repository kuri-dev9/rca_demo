...
NAS_ESM_MSG = {
    ...
    212: "BEARER_RESOURCE_ALLOCATION_REQUEST",
    213: "BEARER_RESOURCE_ALLOCATION_REJECT",
    214: "BEARER_RESOURCE_MODIFICATION_REQUEST",
    215: "BEARER_RESOURCE_MODIFICATION_REJECT",
    217: "ESM_INFORMATION_REQUEST",
    218: "ESM_INFORMATION_RESPONSE",
    219: "NOTIFICATION",
    232: "ESM_STATUS",
    506: "DEACTIVATE_EPS_BEARER_CONTEXT_REQUEST",
}

# Diameter 메시지 코드 (XDR_MessageCode_v0.6.xlsx Diameter 시트 기반)
DIAMETER_MSG = {
    256: "Unassigned",
    257: "CER_CEA",
    258: "RAR_RAA",
    ...
    262: "HAR_HAA",
    265: "AAR_AAA",
    268: "Diameter_EAP_Request_Answer",
    271: "ACR_ACA",
    272: "CCR_CCA",
    273: "Unassigned",
    274: "ASR_ASA",
    ...
    329: "ISR_ISA",
    330: "NCR_NCA",
    8388608: "WIMAX_HRPD_SFF_Request_Answer",
    8388609: "WDER_WDEA",
    8388610: "WCAR_WCAA",
    8388611: "WRAR_WRAA",
    8388612: "WSTR_WSTA",
    ...
    8388724: "NSR_NSA",
    8388725: "NCR_NCA",
    16777214: "Experimental_code",
    16777215: "Experimental_code",
}

# GTPv2C 메시지 코드 (XDR_MessageCode_v0.6.xlsx GTPv2C 시트 기반)
GTPV2C_MSG = {
    1: "ECHO_REQUEST",
    2: "ECHO_RESPONSE",
    3: "VERSION_NOT_SUPPORTED_INDICATION",
    ...
    70: "DOWNLINK_DATA_NOTIFICATION_FAILURE_INDICATION",
    ...
    101: "DELETE_PDN_CONNECTION_SET_REQUEST",
    102: "DELETE_PDN_CONNECTION_SET_RESPONSE",
    103: "PGW_DOWNLINK_TRIGGERING_NOTIFICATION",
    104: "PGW_DOWNLINK_TRIGGERING_ACKNOWLEDGE",
    128: "IDENTIFICATION_REQUEST",
    129: "IDENTIFICATION_RESPONSE",
    130: "CONTEXT_REQUEST",
    131: "CONTEXT_RESPONSE",
    132: "CONTEXT_ACKNOWLEDGE",
    133: "FORWARD_RELOCATION_REQUEST",
    134: "FORWARD_RELOCATION_RESPONSE",
    135: "FORWARD_RELOCATION_COMPLETE_NOTIFICATION",
    136: "FORWARD_RELOCATION_COMPLETE_ACKNOWLEDGE",
    137: "FORWARD_ACCESS_CONTEXT_NOTIFICATION",
    138: "FORWARD_ACCESS_CONTEXT_ACKNOWLEDGE",
    139: "RELOCATION_CANCEL_REQUEST",
    140: "RELOCATION_CANCEL_RESPONSE",
    141: "CONFIGURATION_TRANSFER_TUNNEL",
    149: "DETACH_NOTIFICATION",
    150: "DETACH_ACKNOWLEDGE",
    151: "CS_PAGING_INDICATION",
    152: "RAN_INFORMATION_RELAY",
    153: "ALERT_MME_NOTIFICATION",
    154: "ALERT_MME_ACKNOWLEDGE",
    155: "UE_ACTIVITY_NOTIFICATION",
    156: "UE_ACTIVITY_ACKNOWLEDGE",
    157: "ISR_STATUS_INDICATION",
    160: "CREATE_FORWARDING_TUNNEL_REQUEST",
    161: "CREATE_FORWARDING_TUNNEL_RESPONSE",
    162: "SUSPEND_NOTIFICATION",
    163: "SUSPEND_ACKNOWLEDGE",
    164: "RESUME_NOTIFICATION",
    165: "RESUME_ACKNOWLEDGE",
    166: "CREATE_INDIRECT_DATA_FORWARDING_TUNNEL_REQUEST",
    167: "CREATE_INDIRECT_DATA_FORWARDING_TUNNEL_RESPONSE",
    168: "DELETE_INDIRECT_DATA_FORWARDING_TUNNEL_REQUEST",
    169: "DELETE_INDIRECT_DATA_FORWARDING_TUNNEL_RESPONSE",
    170: "RELEASE_ACCESS_BEARERS_REQUEST",
    171: "RELEASE_ACCESS_BEARERS_RESPONSE",
    176: "DOWNLINK_DATA_NOTIFICATION",
    177: "DOWNLINK_DATA_NOTIFICATION_ACKNOWLEDGE",
    179: "PGW_RESTART_NOTIFICATION",
    180: "PGW_RESTART_NOTIFICATION_ACKNOWLEDGE",
    200: "UPDATE_PDN_CONNECTION_SET_REQUEST",
    201: "UPDATE_PDN_CONNECTION_SET_RESPONSE",
    211: "MODIFY_ACCESS_BEARERS_REQUEST",
    212: "MODIFY_ACCESS_BEARERS_RESPONSE",
...
# S1AP 절차 코드 → 이름 (XDR_MessageCode_v0.6.xlsx S1AP 시트 기반)
S1AP_MSG = {
    0: "HANDOVER_REQUIRED",
    1: "HANDOVER_REQUEST",
    2: "HANDOVER_NOTIFY",
    ...
    4: "HANDOVER_CANCEL",
    5: "E_RAB_SETUP_REQUEST",
    6: "E_RAB_MODIFY_REQUEST",
    7: "E_RAB_RELEASE_COMMAND",
    8: "E_RAB_RELEASE_INDICATION",
    ...
    14: "RESET",
    15: "ERROR_INDICATION",
    16: "NAS_NON_DELIVERY_INDICATION",
    17: "S1_SETUP_REQUEST",
    18: "UE_CONTEXT_RELEASE_REQUEST",
    19: "DOWNLINK_S1_CDMA2000_TUNNELLING",
    20: "UPLINK_S1_CDMA2000_TUNNELLING",
    21: "UE_CONTEXT_MODIFICATION_REQUEST",
    22: "UE_CAPABILITY_INFO_INDICATION",
    23: "UE_CONTEXT_RELEASE_COMMAND",
    24: "eNB_STATUS_TRANSFER",
    25: "MME_STATUS_TRANSFER",
    26: "DEACTIVATE_TRACE",
    27: "TRACE_START",
    28: "TRACE_FAILURE_INDICATION",
    29: "ENB_CONFIGURATION_UPDATE",
    30: "MME_CONFIGURATION_UPDATE",
    31: "LOCATION_REPORTING_CONTROL",
    32: "LOCATION_REPORTING_FAILURE_INDICATION",
    33: "LOCATION_REPORT",
    34: "OVERLOAD_START",
    35: "OVERLOAD_STOP",
    36: "WRITE_REPLACE_WARNING_REQUEST",
    37: "eNB_DIRECT_INFORMATION_TRANSFER",
    38: "MME_DIRECT_INFORMATION_TRANSFER",
    39: "PRIVATE_MESSAGE",
    40: "eNB_CONFIGURATION_TRANSFER",
    41: "MME_CONFIGURATION_TRANSFER",
    42: "CELL_TRAFFIC_TRACE",
    43: "KILL_REQUEST",
    44: "DOWNLINK_UE_ASSOCIATED_LPPA_TRANSPORT",
    45: "UPLINK_UE_ASSOCIATED_LPPA_TRANSPORT",
    46: "DOWNLINK_NON_UE_ASSOCIATED_LPPA_TRANSPORT",
    47: "UPLINK_NON_UE_ASSOCIATED_LPPA_TRANSPORT",
    48: "UE_RADIO_CAPABILITY_MATCH_REQUEST",
    49: "PWS_RESTART_INDICATION",
    50: "E_RAB_MODIFICATION_INDICATION",
    51: "PWS_FAILURE_INDICATION",
    52: "REROUTE_NAS_REQUEST",
    53: "UE_CONTEXT_MODIFICATION_INDICATION",
    54: "CONNECTION_ESTABLISHMENT_INDICATION",
    55: "UE_CONTEXT_SUSPEND_REQUEST",
    56: "UE_CONTEXT_RESUME_REQUEST",
    57: "NAS_DELIVERY_INDICATION",
    58: "RETRIEVE_UE_INFORMATION",
    59: "UE_INFORMATION_TRANSFER",
    60: "eNB_CP_RELOCATION_INDICATION",
    61: "MME_CP_RELOCATION_INDICATION",
    62: "SECONDARY_RAT_DATA_USAGE_REPORT",
}
...
# NAS EMM Cause (XDR_Cause_v0.5.xlsx NAS 시트 기반, 동적 로딩 우선)
NAS_EMM_CAUSE_MAP = {
...
# NAS ESM Cause (XDR_Cause_v0.5.xlsx NAS 시트 기반, 동적 로딩 우선)
NAS_ESM_CAUSE_MAP = {
...
# Diameter Cause (XDR_Cause_v0.5.xlsx Diameter 시트 기반, 동적 로딩 우선)
DIAMETER_CAUSE_MAP = {
    # Success
...
# GTPv2C Cause (XDR_Cause_v0.5.xlsx GTPv2-C 시트 기반)
GTPV2C_CAUSE_MAP = {
    1: "Reserved",
    2: "Local_Detach",
    3: "Complete_Detach",
    4: "RAT_changed_from_3GPP_to_Non_3GPP",
    5: "ISR_deactivation",
    6: "Error_Indication_received_from_RNC_eNodeB_S4_SGSN",
    7: "IMSI_Detach_Only",
    8: "Reactivation_Requested",
    9: "PDN_reconnection_to_this_APN_disallowed",
    10: "Access_changed_from_Non_3GPP_to_3GPP",
    11: "PDN_connection_inactivity_timer_expires",
    12: "PGW_not_responding",
    13: "Network_Failure",
    14: "QoS_parameter_mismatch",
    15: "Spare",
    16: "Request_accepted",
    17: "Request_accepted_partially",
    18: "New_PDN_type_due_to_network_preference",
    19: "New_PDN_type_due_to_single_address_bearer_only",
    64: "Context_Not_Found",
    65: "Invalid_Message_Format",
    66: "Version_not_supported_by_next_peer",
    67: "Invalid_length",
    68: "Service_not_supported",
    69: "Mandatory_IE_incorrect",
    70: "Mandatory_IE_missing",
    71: "Shall_not_be_used",
    72: "System_failure",
    73: "No_resources_available",
    74: "Semantic_error_in_the_TFT_operation",
    75: "Syntactic_error_in_the_TFT_operation",
    76: "Semantic_errors_in_packet_filters",
    77: "Syntactic_errors_in_packet_filters",
    78: "Missing_or_unknown_APN",
    79: "Shall_not_be_used",
    80: "GRE_key_not_found",
    81: "Relocation_failure",
    82: "Denied_in_RAT",
    83: "Preferred_PDN_type_not_supported",
    84: "All_dynamic_addresses_are_occupied",
    ...
    95: "P_TMSI_Signature_mismatch",
    96: "IMSI_IMEI_not_known",
    97: "Semantic_error_in_the_TAD_operation",
    98: "Syntactic_error_in_the_TAD_operation",
    99: "Shall_not_be_used",
    100: "Remote_peer_not_responding",
    101: "Collision_with_network_initiated_request",
    102: "Unable_to_page_UE_due_to_Suspension",
    103: "Conditional_IE_missing",
    104: "APN_Restriction_type_Incompatible_with_currently_active_PDN_connection",
    105: "Invalid_overall_length_of_the_triggered_response_message_and_a_piggybacked_initial_message",
    106: "Data_forwarding_not_supported",
    107: "Invalid_reply_from_remote_peer",
    108: "Fallback_to_GTPv1",
    109: "Invalid_peer",
    110: "Temporarily_rejected_due_to_handover_procedure_in_progress",
    111: "Modifications_not_limited_to_S1_U_bearers",
    112: "Request_rejected_for_a_PMIPv6_reason",
    113: "APN_Congestion",
    114: "Bearer_handling_not_supported",
    115: "UE_already_re_attached",
    116: "Multiple_PDN_connections_for_a_given_APN_not_allowed",
    900: "TIMEOUT",
}
...
def _load_message_codes_from_xlsx() -> None:
    ...
    for row in sheets.get("S1AP", [])[2:]:
        if len(row) > 3:
            _add_message(["S1MME_S1AP"], row[2], row[3] or row[1])
